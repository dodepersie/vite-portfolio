...
export const techStack = [
    {'logo': faHashtag, 'name': 'frame_work', dec: 'Bootstrap, Laravel, mySQL, Next JS, React, Tailwind'},
...
export const projects = [
    ...
    },
    {
      id: 5,
      title: 'Laravel Blog',
      description: "This my blog where I'll share my experiences and also a ✨ little ✨ thing that I know. *Not published yet*",
        image: p5,
