  ...
  return (
    <section id="projects">
      <div className="hero min-h-screen dark:bg-slate-900 dark:text-gray-50 p-auto md:p-4 transition-colors ease-in duration-50">
        <div className="hero-content py-10 px-7">
          <div className="lg:grid grid-cols-6 gap-10 justify-between text-base tracking-tight mt-auto">
            <div
            ...
            >
              ...
              <h1 className="font-semibold text-5xl lg:text-9xl text-blue-700 dark:text-slate-400">
                Projects
              </h1>
