            ...
            <div className="hero min-h-screen p-auto bg-gray-50 text-black dark:bg-slate-800 dark:text-gray-50">
                <div className="hero-content flex-col-reverse lg:flex-row p-auto md:p-14 lg:p-auto gap-10">
                    <div className="w-full md:w-1/2 text-center md:text-left" data-aos="fade-right">
                        ...
                        <a onClick={handleGoBack} className="btn bg-blue-500 hover:bg-blue-600 active:bg-blue-700 dark:bg-slate-500 dark:hover:bg-slate-600 dark:active:bg-slate-700 text-gray-50 btn-block border-0 lg:w-40"><FontAwesomeIcon icon={faArrowCircleLeft} className="mr-4" />Go back</a>        
                    </div>     
