              ...
              <div className="flex flex-col md:flex-row justify-start items-start pt-4 gap-5">
                <div>
                  <p className="leading-loose pb-5">
                    ...
                    <strong>cPanel</strong> and <strong>mySQL</strong>. In 2013
                    I learned <strong>PHP</strong> and also the{" "}
                    <strong>Twitter API</strong> and I created a website to{" "}
                    <strong>exchange Twitter followers</strong> and also
                    provided the Admin Panel. I build the Admin Panel using{" "}
                  ...
                  <p className="leading-loose">
                    ...
                    in a{" "}
                    <strong>Primary School Level Computer Competition</strong>{" "}
                    at <strong>Kabupaten Tabanan</strong>. And one more in 2015,
                    i have got <strong>Second place</strong> in a{" "}
                    <strong>
